...
parser.add_argument('--input_dir', default='/home/long/data/LLIE/FiveK/FiveK/test/input',
...
parser.add_argument(
    '--opt', type=str, default='./Options/NewRetinexSCUNet10_COCO_ms_per_gan5.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='/home/long/LLIE/Retinexformer/experiments/NewRetinexSCUNet10_COCO_ms_per_gan5/best_psnr_22.491_139000.pth',
                    type=str, help='Path to weights')
parser.add_argument('--dataset', default='LOL_v2', type=str,
                    help='Test Dataset')
...
parser.add_argument('--self_ensemble', default=False, action='store_true', help='Use self-ensemble to obtain better results')
